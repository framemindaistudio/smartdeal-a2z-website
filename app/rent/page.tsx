...
export default function RentPage() {
  const picks = PROPERTIES.filter((p) => p.purpose === "For Rent").slice(0, 3);
    ...
    <div>
      ...
      <section className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8">
        <SectionHeading
          ...
          title="Rentals Ready to Move In"
          description="A quick look at current rental listings — see all properties for the full inventory."
        />
        {picks.length > 0 ? (
          ...
          <p className="text-sm text-slate-600">
            No rental listings are live just yet — check back soon or browse all properties.
          </p>
        )}
        <div className="mt-8 text-center">
          <Link
            href="/properties?purpose=For+Rent"
